...
<div class="pageContent">
	<form method="post" action="__URL__/update/navTabId/listarticle/callbackType/closeCurrent"  class="pageForm required-validate" 
		...
		<div class="pageFormContent" layoutH="60">
			...
			<dl>
				<dt>文章来源：</dt>
				<dd><input type="text" class=""  style="width:100%" name="source" value="<?php echo ($vo["source"]); ?>"/></dd>
			</dl>
			<dl>
				<dt>作者：</dt>
				<dd><input type="text" class=""  style="width:100%" name="author" value="<?php echo ($vo["author"]); ?>"/></dd>
			</dl>
			<dl>
				<dt>关键词：</dt>
