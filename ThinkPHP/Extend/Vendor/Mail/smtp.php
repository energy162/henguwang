...
class smtp {
	...
	public function smtp($app) {
        ...
        if(constant("ECAE_MODE")) {
			...
			vendor('Mail.smtp.fsockopen'); 
			$this->_adapter = new desktop_email_smtp_fsockopen();
			//$this->_adapter = kernel::single("desktop_email_smtp_fsockopen");
		}else if(function_exists("curl_init")) {
			vendor('Mail.smtp.curl'); 
			$this->_adapter = new desktop_email_smtp_curl();
			//$this->_adapter = kernel::single("desktop_email_smtp_curl");
		} else {
			die("smtp no support!");
		}
